...
def main():
	...
	try:
		subprocess.call(['pip3', 'install', 'adafruit-blinka', 'adafruit-circuitpython-ads1x15', 'adafruit-circuitpython-htu21d', 'adafruit-circuitpython-bmp280', 'adafruit-circuitpython-bme280'])
		print(_('DONE'))
